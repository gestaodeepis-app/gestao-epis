...
if($("dashboardPlantFilter"))$("dashboardPlantFilter").addEventListener("change",()=>{dashboardPlantId=assignedPlantId()||$("dashboardPlantFilter").value;if($("mobileDashboardPlantFilter"))$("mobileDashboardPlantFilter").value=dashboardPlantId;renderDashboard()});
if($("mobileDashboardPlantFilter"))$("mobileDashboardPlantFilter").addEventListener("change",()=>{dashboardPlantId=assignedPlantId()||$("mobileDashboardPlantFilter").value;if($("dashboardPlantFilter"))$("dashboardPlantFilter").value=dashboardPlantId;renderDashboard()});
