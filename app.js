...
function navTo(view){
  ...
  $("dashboardPlantWrap").style.display=view==="dashboard"?"":"none";
...
function renderMenuBadges(){
  ...
  mb.textContent=pend;mb.classList.toggle("hidden",!pend);
  eb.textContent=low;eb.classList.toggle("hidden",!low);
}
...
function renderEmployees(){
  ...
  $("employeeCards").innerHTML=list.map(e=>{
...
function populateDashboardFilters(){
  const dashboard=$("dashboardPlantFilter"), epiFilter=$("epiPlantFilter");
...
$("dashboardPlantFilter").addEventListener("change",()=>{dashboardPlantId=$("dashboardPlantFilter").value;renderDashboard()});
